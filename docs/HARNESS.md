...
|---|---|---|---|
| Suspect-zone benchmark | `npm run benchmark` | 53-fixture hot/cold accuracy, ROC/PR-AUC, F1, confusion — the regression guard | [tests/quality/README.md](../tests/quality/README.md) |
