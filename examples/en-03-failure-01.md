...
> The new tariff increased costs by 12%, pushing firms to cut staff and forcing two smaller suppliers to close entirely. The resulting layoffs hit the rural southeast hardest, eliminating about 800 jobs in a region that was already struggling with high unemployment.

## Expected Output

> (No correction — this text should not trigger Pattern 3)
