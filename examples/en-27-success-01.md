...
# Pattern 27 (en): Zombie Nouns (Excessive Nominalization) — Success Case

## Input Text

> The committee made a decision to conduct an investigation into the matter and provide a recommendation regarding the implementation of improvements to the current system. An evaluation of the available options was performed, and consideration was given to each alternative. The team then carried out an assessment of the projected costs and reached a conclusion that a reduction in overhead spending would have a significant impact on overall profitability.
