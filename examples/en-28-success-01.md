...
# Pattern 28 (en): Stacked Subordinate Clauses — Success Case

## Input Text

> The initiative, which was developed in response to growing concerns about, and increasing awareness of, the challenges that both urban and rural communities, particularly those in economically disadvantaged regions, face in the context of rapid technological change, seeks to address the gap between those who benefit from digital infrastructure and those who, despite repeated government promises, have been left without reliable internet access.
