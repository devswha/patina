...
**발화 조건:** 짧은 명사구 뒤에 콜론을 붙여 나머지를 극적인 반전처럼 연출하는 문장("반전:", "핵심은 이것:", "더 놀라운 건:", "진짜 이유:", "보너스:", "결과:")이 산문에서 2회 이상 등장하거나, 1회라도 평서문으로 바꿔 잃는 것이 없는 경우. 목록·라벨·정의가 아닌 산문에 한정.

**제외 조건:**
- 구조적 역할을 하는 콜론: 목록 도입, 항목 라벨, 정의, 인용 표시, 제목, 코드
- 필자가 의도적으로 쓴 SNS 단문 카피의 단발성 콜론 연출

**의미 위험도:** LOW

**문제:** AI는 콜론으로 드라마를 제조한다. 두세 단어 셋업, 한 박자, 그리고 "공개". 한 번이면 리듬 선택이지만 반복되면 모든 문단이 펀치라인 전달 기계가 되고, 참여 최적화 카피처럼 읽힌다. 평서문으로 바꾸고 내용은 유지한다.
...
**이 패턴이 아닌 것:** 같은 박자를 만드는 대시 연출 → Pattern 13 (대시 과용). "**라벨:** 설명" 불릿 → Pattern 15 (인라인 헤더 목록). 짧은 문장 쌓기 → ko-viral-hook #4. #37은 산문 속 콜론 연출에 한정.
