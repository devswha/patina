...
const STRINGS = {
  en: {
    ...
    'hero.eyebrow': 'audit-only playground',
    'hero.title': 'Paste text. See where it sounds packaged.',
    'hero.body':
      'patina checks deterministic stylometry and lexicon signals for Korean, English, Chinese, and Japanese. v1 does not rewrite, call an LLM, or send your pasted text anywhere.',
  ...
  ko: {
    ...
    'hero.eyebrow': '감사 전용 플레이그라운드',
    'hero.title': '텍스트를 붙여넣고, 어디가 포장된 느낌인지 확인하세요.',
    'hero.body':
      'patina는 한국어·영어·중국어·일본어에 대해 결정론적 문체(스타일로메트리)와 어휘 신호를 점검합니다. v1은 다시 쓰거나, LLM을 호출하거나, 붙여넣은 텍스트를 어디로도 보내지 않습니다.',
