...
export function formatMarkdown(rows, { input = DEFAULT_INPUT } = {}) {
  ...
  lines.push('3. In iterative-baseline selection, prefer candidates that pass MPS and lower the AI score; do not let high MPS alone rescue a visibly AI-like rewrite.');
